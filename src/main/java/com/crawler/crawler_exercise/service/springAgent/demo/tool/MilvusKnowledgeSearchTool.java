...
public class MilvusKnowledgeSearchTool {
    ...
    public MilvusKnowledgeSearchTool(MilvusConfig milvusConfig, ToolTraceContext toolTraceContext) {
    ...
    public String knowledgeSearch(@ToolParam(description = "User question for retrieval") String query) {
        ...
        toolTraceContext.addSource("milvus:" + milvusConfig.getCollectionName());
